...
#define HAVE_sse4_2_crc32di (TARGET_64BIT && TARGET_CRC32)
...
#define HAVE_lwp_lwpvaldi ((TARGET_LWP) && (TARGET_64BIT))
#define HAVE_lwp_lwpinssi (TARGET_LWP)
#define HAVE_lwp_lwpinsdi ((TARGET_LWP) && (TARGET_64BIT))
...
#define HAVE_rdranddi ((TARGET_RDRND) && (TARGET_64BIT))
#define HAVE_rdseedhi (TARGET_RDSEED)
#define HAVE_rdseedsi (TARGET_RDSEED)
#define HAVE_rdseeddi ((TARGET_RDSEED) && (TARGET_64BIT))
#define HAVE_rdsspsi (TARGET_SHSTK || (flag_cf_protection & CF_RETURN))
#define HAVE_rdsspdi ((TARGET_SHSTK || (flag_cf_protection & CF_RETURN)) && (TARGET_64BIT))
#define HAVE_incsspsi (TARGET_SHSTK || (flag_cf_protection & CF_RETURN))
#define HAVE_incsspdi ((TARGET_SHSTK || (flag_cf_protection & CF_RETURN)) && (TARGET_64BIT))
#define HAVE_saveprevssp (TARGET_SHSTK)
#define HAVE_rstorssp (TARGET_SHSTK)
#define HAVE_wrsssi (TARGET_SHSTK)
#define HAVE_wrssdi ((TARGET_SHSTK) && (TARGET_64BIT))
#define HAVE_wrusssi (TARGET_SHSTK)
#define HAVE_wrussdi ((TARGET_SHSTK) && (TARGET_64BIT))
...
#define HAVE_fmav2sf4 ((TARGET_FMA || TARGET_FMA4) && TARGET_MMX_WITH_SSE)
#define HAVE_fmsv2sf4 ((TARGET_FMA || TARGET_FMA4) && TARGET_MMX_WITH_SSE)
#define HAVE_fnmav2sf4 ((TARGET_FMA || TARGET_FMA4) && TARGET_MMX_WITH_SSE)
#define HAVE_fnmsv2sf4 ((TARGET_FMA || TARGET_FMA4) && TARGET_MMX_WITH_SSE)
#define HAVE_mmx_fix_truncv2sfv2si2 (TARGET_3DNOW || TARGET_MMX_WITH_SSE)
#define HAVE_fixuns_truncv2sfv2si2 (TARGET_MMX_WITH_SSE && TARGET_AVX512VL)
#define HAVE_mmx_floatv2siv2sf2 (TARGET_3DNOW || TARGET_MMX_WITH_SSE)
#define HAVE_floatunsv2siv2sf2 (TARGET_MMX_WITH_SSE && TARGET_AVX512VL)
...
#define HAVE_floatunsv2siv2df2 (TARGET_MMX_WITH_SSE && TARGET_AVX512VL)
#define HAVE_sse2_cvtpd2pi (TARGET_SSE2)
#define HAVE_sse2_cvttpd2pi (TARGET_SSE2)
#define HAVE_fixuns_truncv2dfv2si2 (TARGET_MMX_WITH_SSE && TARGET_AVX512VL)
...
#define HAVE_truncv2dfv2sf2 (TARGET_MMX_WITH_SSE)
...
#define HAVE_extendv2sfv2df2 (TARGET_MMX_WITH_SSE)
...
#define HAVE_avx512vl_ss_truncatev2div2qi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_truncatev2div2qi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_us_truncatev2div2qi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
...
#define HAVE_avx512vl_ss_truncatev4siv4qi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_truncatev4siv4qi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_us_truncatev4siv4qi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_ss_truncatev4div4qi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_truncatev4div4qi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_us_truncatev4div4qi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
...
#define HAVE_avx512vl_ss_truncatev8hiv8qi2_mask_store_2 ((TARGET_AVX512VL && ix86_pre_reload_split ()) && (TARGET_AVX512BW))
#define HAVE_avx512vl_truncatev8hiv8qi2_mask_store_2 ((TARGET_AVX512VL && ix86_pre_reload_split ()) && (TARGET_AVX512BW))
#define HAVE_avx512vl_us_truncatev8hiv8qi2_mask_store_2 ((TARGET_AVX512VL && ix86_pre_reload_split ()) && (TARGET_AVX512BW))
#define HAVE_avx512vl_ss_truncatev8siv8qi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_truncatev8siv8qi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_us_truncatev8siv8qi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_ss_truncatev4div4hi2 (TARGET_AVX512VL)
#define HAVE_avx512vl_truncatev4div4hi2 (TARGET_AVX512VL)
#define HAVE_avx512vl_us_truncatev4div4hi2 (TARGET_AVX512VL)
...
#define HAVE_avx512vl_ss_truncatev4siv4hi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_truncatev4siv4hi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_us_truncatev4siv4hi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_ss_truncatev4div4hi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_truncatev4div4hi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_us_truncatev4div4hi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
...
#define HAVE_avx512vl_ss_truncatev2div2hi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_truncatev2div2hi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_us_truncatev2div2hi2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
...
#define HAVE_avx512vl_ss_truncatev2div2si2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_truncatev2div2si2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512vl_us_truncatev2div2si2_mask_store_2 (TARGET_AVX512VL && ix86_pre_reload_split ())
#define HAVE_avx512f_ss_truncatev8div16qi2 (TARGET_AVX512F)
#define HAVE_avx512f_truncatev8div16qi2 (TARGET_AVX512F)
#define HAVE_avx512f_us_truncatev8div16qi2 (TARGET_AVX512F)
...
#define HAVE_avx512f_ss_truncatev8div16qi2_mask_store_2 (TARGET_AVX512F && ix86_pre_reload_split ())
#define HAVE_avx512f_truncatev8div16qi2_mask_store_2 (TARGET_AVX512F && ix86_pre_reload_split ())
#define HAVE_avx512f_us_truncatev8div16qi2_mask_store_2 (TARGET_AVX512F && ix86_pre_reload_split ())
...
#define HAVE_absti2 ((TARGET_CMOVE \
...
#define HAVE_umindi3 (TARGET_CMOVE \
   && (DImode != QImode || !TARGET_PARTIAL_REG_STALL))
#define HAVE_smaxti3 ((TARGET_CMOVE \
   && (TImode != QImode || !TARGET_PARTIAL_REG_STALL)) && (TARGET_64BIT))
#define HAVE_sminti3 ((TARGET_CMOVE \
   && (TImode != QImode || !TARGET_PARTIAL_REG_STALL)) && (TARGET_64BIT))
#define HAVE_umaxti3 ((TARGET_CMOVE \
   && (TImode != QImode || !TARGET_PARTIAL_REG_STALL)) && (TARGET_64BIT))
#define HAVE_uminti3 ((TARGET_CMOVE \
   && (TImode != QImode || !TARGET_PARTIAL_REG_STALL)) && (TARGET_64BIT))
...
#define HAVE_addv2sf3 (TARGET_MMX_WITH_SSE)
#define HAVE_mmx_subv2sf3 (TARGET_3DNOW)
#define HAVE_mmx_subrv2sf3 (TARGET_3DNOW)
#define HAVE_subv2sf3 (TARGET_MMX_WITH_SSE)
#define HAVE_mmx_mulv2sf3 (TARGET_3DNOW)
#define HAVE_mulv2sf3 (TARGET_MMX_WITH_SSE)
#define HAVE_mmx_smaxv2sf3 (TARGET_3DNOW)
#define HAVE_mmx_sminv2sf3 (TARGET_3DNOW)
#define HAVE_smaxv2sf3 (TARGET_MMX_WITH_SSE)
#define HAVE_sminv2sf3 (TARGET_MMX_WITH_SSE)
#define HAVE_mmx_haddv2sf3 (TARGET_3DNOW)
#define HAVE_mmx_haddsubv2sf3 (TARGET_3DNOW_A)
#define HAVE_mmx_eqv2sf3 (TARGET_3DNOW)
#define HAVE_copysignv2sf3 (TARGET_MMX_WITH_SSE)
#define HAVE_xorsignv2sf3 (TARGET_MMX_WITH_SSE)
#define HAVE_signbitv2sf2 (TARGET_MMX_WITH_SSE)
#define HAVE_fix_truncv2sfv2si2 (TARGET_MMX_WITH_SSE)
#define HAVE_floatv2siv2sf2 (TARGET_MMX_WITH_SSE)
...
#define HAVE_rsqrtv16sf2 ((TARGET_SSE && TARGET_SSE_MATH) && (TARGET_AVX512ER))
...
#define HAVE_floatv2siv2df2 (TARGET_MMX_WITH_SSE)
#define HAVE_fix_truncv2dfv2si2 (TARGET_MMX_WITH_SSE)
...
#define HAVE_truncv8dfv8sf2 ((TARGET_AVX) && (TARGET_AVX512F))
#define HAVE_truncv4dfv4sf2 (TARGET_AVX)
#define HAVE_extendv8sfv8df2 ((TARGET_AVX) && (TARGET_AVX512F))
...
#define HAVE_truncv16siv16qi2 (TARGET_AVX512F)
#define HAVE_truncv16siv16hi2 (TARGET_AVX512F)
#define HAVE_truncv8div8si2 (TARGET_AVX512F)
#define HAVE_truncv8div8hi2 (TARGET_AVX512F)
...
#define HAVE_truncv32hiv32qi2 (TARGET_AVX512BW)
...
#define HAVE_truncv4div4si2 (TARGET_AVX512VL)
#define HAVE_truncv8siv8hi2 (TARGET_AVX512VL)
#define HAVE_truncv16hiv16qi2 ((TARGET_AVX512VL) && (TARGET_AVX512BW))
...
#define HAVE_truncv4div4qi2 (TARGET_AVX512VL)
#define HAVE_truncv2div2qi2 (TARGET_AVX512VL)
#define HAVE_truncv8siv8qi2 (TARGET_AVX512VL)
#define HAVE_truncv4siv4qi2 (TARGET_AVX512VL)
#define HAVE_truncv8hiv8qi2 ((TARGET_AVX512VL) && (TARGET_AVX512BW))
#define HAVE_truncv4diV4HI2 (TARGET_AVX512VL)
#define HAVE_truncv2diV2HI2 (TARGET_AVX512VL)
#define HAVE_truncv4siV4HI2 (TARGET_AVX512VL)
#define HAVE_truncv2div2si2 (TARGET_AVX512VL)
#define HAVE_truncv8div8qi2 (TARGET_AVX512F)
...
#define HAVE_mulv8qi3 (TARGET_AVX512VL && TARGET_AVX512BW)
#define HAVE_mulv64qi3 ((TARGET_SSE2) && (TARGET_AVX512BW))
...
#define HAVE_popcountv16si2 (TARGET_AVX512VPOPCNTDQ)
...
#define HAVE_popcountv8di2 (TARGET_AVX512VPOPCNTDQ)
...
#define HAVE_popcountv64qi2 (TARGET_AVX512BITALG)
...
#define HAVE_popcountv32hi2 (TARGET_AVX512BITALG)
...
extern rtx        gen_rdranddi                                   (rtx);
extern rtx        gen_rdseedhi                                   (rtx);
extern rtx        gen_rdseedsi                                   (rtx);
extern rtx        gen_rdseeddi                                   (rtx);
...
extern rtx        gen_smaxti3                                    (rtx, rtx, rtx);
extern rtx        gen_sminti3                                    (rtx, rtx, rtx);
extern rtx        gen_umaxti3                                    (rtx, rtx, rtx);
extern rtx        gen_uminti3                                    (rtx, rtx, rtx);
